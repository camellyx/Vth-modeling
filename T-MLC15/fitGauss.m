...
%     binpdf.P3 = mpdf.P3([1:102 202:301 401:502]);
    ...
    % find minimal loss
    [v, err, exitflag, output] = fminsearch(objfun, v, optimset('MaxIter', 2e3, 'MaxFunEvals', 4e3, 'TolFun', 1e-9, 'TolX', 1e-9, 'FunValCheck', 'on'));
    ...
    semilogy(39:231, pdf('Normal', 39:231, v(2), v(3)), 'm');
    semilogy(39:231, pdf('Normal', 39:231, v(4), v(5)), 'b');
    semilogy(39:231, pdf('Normal', 39:231, v(6), v(7)), 'r');
    semilogy(39:231, pdf('Normal', 39:231, v(8), v(9)), 'k');
